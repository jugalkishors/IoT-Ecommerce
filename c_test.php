...
<!-- Here logout values -->
    ...
    <div class="col-sm-2 col-md-2 col-lg-2"><h5><?php echo $result1['pro_name']; ?></h5></div>
    <div class="col-sm-2 col-md-2 col-lg-2"></div>
    <div class="col-sm-2 col-md-2 col-lg-2"><p><span id="prc<?php echo $product_id; ?>"><?php echo $result1['real_price'];?></span> ₹</p></div>
    <div class="col-sm-2 col-md-2 col-lg-2"><p><b>x</b>&nbsp;&nbsp;&nbsp;<button onclick="increament<?php echo $product_id; ?>()">+</button> <input style="width: 40px;" type="number" min="1" id="qtty<?php echo $product_id; ?>" name="qty" value="<?php echo $result['qty']; ?>" disabled=""><button onclick="decreament<?php echo $product_id; ?>()">-</button></p></div>
    <span class="col-sm-12 col-md-12 col-lg-12"><hr></span>
    <input type="hidden" name="productid[]" value="<?php echo $product_id; ?>">
</div>

<script type="text/javascript">
  function increament<?php echo $product_id; ?>(){
    var inc = document.getElementById('qtty<?php echo $product_id; ?>').stepUp(1);
    var qty = document.getElementById('qtty<?php echo $product_id; ?>').value;
    var price = '<?php echo $result1['real_price'];?>';
    price = +price;
    var total = qty*price;
    document.getElementById('prc<?php echo $product_id; ?>').innerHTML = total;
    
  }

  function decreament<?php echo $product_id; ?>(){
    var inc = document.getElementById('qtty<?php echo $product_id; ?>').stepDown(1);
    var qty = document.getElementById('qtty<?php echo $product_id; ?>').value;
    var price = '<?php echo $result1['real_price'];?>';
    price = +price;
    var total = qty*price;
